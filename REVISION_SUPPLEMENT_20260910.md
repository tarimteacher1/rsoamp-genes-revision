**Final merged workbook:** Use the [merged update guide](REVISION_UPDATE_20260910.md), the current root S1–S59 workbook, or `Supplementary_Tables_S1-S59_merged_20260910.xlsx` in the release. These combine the S21 clarification with the S25 correction below. The initial non-merged release workbook is retained as an earlier record.
